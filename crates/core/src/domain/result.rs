...
pub struct CheckResult {
    ...
    /// org silently misfiles results under another tenant.
    pub org_id: OrgId,
...
impl CheckResult {
    pub fn error(target_id: Uuid, org_id: OrgId, reason: impl Into<String>) -> Self {
    ...
    pub fn is_served_stale(&self) -> bool {
        self.error.as_deref().is_some_and(|e| e.starts_with(SERVED_STALE_PREFIX))
    }
}
